...
SubPixEdgeOptimizer::SubPixEdgeOptimizer( const rom::ImageCut & line )
...
void SubPixEdgeOptimizer::subPix( int n, const NEWMAT::ColumnVector& x, double& fx, int& result, void *objPtr )
{
	...
	const double normDir = rom::numerical::distancePoints2D( this_ptr->_line._start, this_ptr->_line._stop );
