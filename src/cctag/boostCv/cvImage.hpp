...
inline std::ostream& operator<<( std::ostream& os, const cctag::boostCv::CvImageView & image )
{
	os << *image.get();
	return os;
}

inline std::ostream& operator<<( std::ostream& os, const cctag::boostCv::CvImageContainer & image )
{
	os << *image.get();
	return os;
}
