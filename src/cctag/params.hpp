...
static const float kDefaultCannyThrLow      =  0.004f ;//0.002
static const float kDefaultCannyThrHigh     =  0.02f ;// 0.04
...
static const std::size_t kDefaultNumCutsInIdentStep = 20;//100;//15;
